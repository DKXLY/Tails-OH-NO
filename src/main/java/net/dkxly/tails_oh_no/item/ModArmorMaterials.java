...
public enum ModArmorMaterials implements ArmorMaterial {
    CHECKMARKED_SHOES("checkmarked_shoes", 37, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        map.put(ArmorItem.Type.BOOTS, 7);
    }), 20, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0f, 0.5f, () -> Ingredient.ofItems(NETHERITE_INGOT));
